      ...
      <section className="blog-items team-cards">
          <div className="inner-wrapper">
            <div className="blog-container">
              <ProfileCard pic={homer} name={"Homer Simpson"} description={"Loves his family as much as donuts"} email={"homer@simpson.com"}/>
              ...
              <ProfileCard pic={bart} name={"Bart Simpson"} description={"Bart is the etemal prankster"} email={"bart@simpson.com"}/>
            </div>
          </div>
      </section>
    </div>
